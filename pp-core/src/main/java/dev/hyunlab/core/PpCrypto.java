...
public class PpCrypto {
	...
	public static void main(String[] args) {
		System.out.println(PpCrypto.sha512("admin@123"));	//a1102957491b9ce5441e111f7725f2fd0201bc32465e2536e5182d1c5e3f6b0965355c09f2c8b9111ab6d18a73b75f0f3a06e788bd2a6dff4ddc7c4da6ada603
		System.out.println(PpCrypto.sha512("rda@123"));	//5ece07bbc2bf53a6d3fff11df6ad5af602f16baa8d4d9e3053ab054374c4c82d7922885defdc40de35d321b62adfc0308ca43876390c579ed21400a89cc2e457
		System.out.println(PpCrypto.sha512("mngr@sejong"));
	...
	public static Map<String,Object> decrypt(Map<String, Object> data, String...keys) {
		...
		for(String k : keys) {
			if(data.containsKey(k)) {
				data.put(k + "_DEC", PpCrypto.decrypt(""+data.get(k)));

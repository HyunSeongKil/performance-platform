...
class Pp {
     ...
     * @returns
     */
    static nan(obj, defaultValue=Number.NaN){
        if(Pp.isNull(obj)){
            return defaultValue;
        }
    ...
    static stopWatch(gbn, key){
        ...
        if('stop' === gbn){
            ...
            //소요시간 ms 리턴
            let leadTime = window[key]['stop'].getTime() - window[key]['start'].getTime();
